...
Data = sc.textFile(r'/home/ccirelli2/Desktop/Scalable_Analytics/Final_Project/yellow_tripdata_2017-02.csv')

Data_splitNewLine = Data.map(lambda x: x.split(','))

print('@@@@@@@@', Data_splitNewLine.take(20))
...
U_DO_NumPass = df_TripData.select(df_TripData['tpep_pickup_datetime'],
